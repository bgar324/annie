...
export function buildAssistantSystemPrompt(input: {
  ...
  return [
    ...
    "Before a Notion update, search for the exact page title and use a complete result, then fetch it now and reuse its page ID and safe workspace. Change one checkbox marker in a unique fetched excerpt; include heading context for repeats. Do not bundle cleanup or formatting.",
