...
export const assistantResponseFormatReminder = [
  ...
  "Every section header in a tool-backed report must begin with an emoji and end with a colon. This includes nested sections such as needs attention, worth a peek, and ignore.",
...
export function buildAssistantSystemPrompt(input: {
  ...
  return [
    ...
    "Every section header in a tool-backed report must start with a relevant emoji and end with a colon, including nested sections. The first character of every result-item line must be ›, with no hyphen or other bullet before it. Examples: 📅 today:, 📬 inbox:, 🚨 needs attention:, 👀 worth a peek:, 🗑️ ignore:, ✅ tasks:, 📁 recent work:. Short conversational replies that do not report tool results need no header.",
