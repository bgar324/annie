  ...
  return [
    {
      definition: {
        ...
        description:
          "List the accounts connected to Ben right now, including each safe label, provider, health status, and capabilities. Use this as the authoritative source for connection questions.",
        parameters: {
          type: "object",
          properties: {},
          required: [],
